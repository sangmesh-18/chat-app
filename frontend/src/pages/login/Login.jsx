        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div className='flex  items-center justify-center'>
              <input type={visible ? "text" : "password"} value={password} onChange={(e)=>setPassword(e.target.value)}  placeholder='Enter password' className='w-full input input-bordered h-10' />
              <button type='button' onClick={changeClickHandler}>
                {
